...
const newEntries = `
  ...
  'Thermal Window (28.4°C)': {
    ...
    gu: 'તાપમાન સ્તર (૨૮.૪°C)', bn: 'তাপমাত্রা স্তর (২৮.৪°C)', pa: 'ਤਾਪਮਾਨ ਪੱਧਰ (28.4°C)', kn: 'ತಾಪಮಾನ ಮಟ್ಟ (28.4°C)',
  ...
  'Irrigation & Water Management:': {
    ...
    gu: 'સિંચાઈ અને જળ વ્યવસ્થાપન:', bn: 'সেচ ও জল ব্যবস্থাপনা:', pa: 'ਸਿੰਚਾਈ ਅਤੇ ਪਾਣੀ ਪ੍ਰਬੰਧਨ:', kn: 'ನೀರಾವರಿ & ಜಲ ನಿರ್ವಹಣೆ:',
