...
const targetFile = path.resolve(__dirname, '../src/components/chat/AssistantDrawer.jsx');
...
export default function AssistantDrawer() {
  ...
  const handleSpeak = (text) => {
    if ('speechSynthesis' in window) {
      ...
      utterance.lang = voiceLangs[lang] || 'hi-IN';
...
console.log('Successfully patched AssistantDrawer.jsx!');
